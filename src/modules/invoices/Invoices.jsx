...
const emptyManualInvoice = { clientName: "", jobAddress: "", clientPhone: "", clientEmail: "", notes: "" };
...
export default function Invoices() {
  ...
  const updateInvoiceField = (invoiceId, field, value) => {
    updateAppData((currentData) => ({ ...currentData, invoices: (currentData.invoices || []).map((invoice) => invoice.id === invoiceId ? recalc({ ...invoice, [field]: value }, currentData) : invoice) }));
  };

  const markPaid = (invoice) => updateInvoiceField(invoice.id, "paidAmount", invoice.totals?.total || 0);
